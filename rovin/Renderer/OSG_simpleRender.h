...
namespace rovin
{
	...
	public:
		typedef std::pair< osg::ref_ptr< osg::MatrixTransform >, const LinkState* > NodeStatePair;
		OSG_simpleRender(const SerialOpenChain& assem, const State& state, int width, int height);
